...
public class BtSPPYbx{
    ...
    public BtSPPYbx (Context context) {
        ...
        if (address == "") {
            ...
            if (myBluetoothAdapter == null) {
                ...
                if (myDevice == null) {
                    ...
                    Log.d("BtSPPYbx SPPOpen", "开始打开SPPOpen");
                    boolean res = this.SPPOpen(myBluetoothAdapter, myDevice);
                    System.out.println("sppopen 结果" + res);
                    return res;
                }
            }
        }
